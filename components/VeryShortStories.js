...
export default function Hero() {
    ...
    return (
        <article className="hero relative overflow-hidden">
            ...
            <img src={VeryShortStories[6].image.src} height={VeryShortStories[6].image.src.height} width={VeryShortStories[6].image.src.width} className="h-full absolute lg:left-20 -bottom-0"/>
        </article>
    )
}