...
export default function Hero() {
    ...
    return (
        <article className="hero relative overflow-hidden">
            ...
            <img src={VeryShortStories[3].image.src} height={VeryShortStories[3].image.src.height} width={VeryShortStories[3].image.src.width} className="h-full absolute left-2/6 -bottom-3 lg:block hidden"/>
            <img src={VeryShortStories[6].image.src} height={VeryShortStories[6].image.src.height} width={VeryShortStories[6].image.src.width} className="h-full absolute lg:left-3 -bottom-0"/>
        </article>
    )
}