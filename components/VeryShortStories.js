...
export default function Hero() {
    ...
    return (
        <article className="hero relative overflow-hidden">
            ...
            {/* <Image src={VeryShortStories[1].image.src} height={VeryShortStories[1].image.src.height} width={VeryShortStories[1].image.src.width/2.2} className="h-full absolute left-3/4 -bottom-6 lg:block hidden"/>
            <Image src={VeryShortStories[3].image.src} height={VeryShortStories[3].image.src.height} width={VeryShortStories[3].image.src.width} className="h-full absolute left-2/6 -bottom-3 lg:block hidden"/>
            <Image src={VeryShortStories[6].image.src} height={VeryShortStories[6].image.src.height} width={VeryShortStories[6].image.src.width} className="h-full absolute lg:left-3 -bottom-0"/> */}
        </article>
    )
}